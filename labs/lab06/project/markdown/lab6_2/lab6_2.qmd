# Модель эпидемии. Случай 2: I(0) > I*
...
Рассмотрим случай, когда \(I(0) > I^*\) (больные способны заражать восприимчивых к болезни особей).
...
Когда число заболевших превышает критическое значение \(I^*\),
